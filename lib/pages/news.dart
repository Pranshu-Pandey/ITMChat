...
import 'package:itmchat/pages/view_rss_feed.dart';

class News extends StatefulWidget {
  const News({Key key, this.title: 'News'}) : super(key: key);
  ...
  @override
  State<News> createState() => _FirstScreenState();
}

class _FirstScreenState extends State<News> {
  ...
  loadData() async {
    try {
      ...
      //const API = 'https://www.livemint.com/rss/news';
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ElevatedButton(
              onPressed: () => loadData(),
              child: Row(
                children: [Icon(Ionicons.refresh_circle), Text('Refresh')],
              ))
        ],
        centerTitle: true,
      ),
                  ...
                  itemBuilder: (BuildContext context, index) {
                    ...
                    return InkWell(
                        onTap: () => Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    ViewRssScreen(RssFeed: feedItems))),
                        child: ListTile(
                          leading: Image(
